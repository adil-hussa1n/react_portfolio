...
const projects = [
  {
    id: 1,
    src: imgNew1,
    title: 'The Cage Cafe POS',
    description: 'A full-stack point-of-sale (POS) cafe billing and order management system.',
    longDescription: 'The Cage Cafe POS is a premium React 19 + Laravel point-of-sale cafe system. It features multiple Zustand state stores, cart management, real-time transaction calculations, a robust order state machine (dine-in/takeaway status flows), interactive table management, dark mode support, and a detailed sales dashboard.',
